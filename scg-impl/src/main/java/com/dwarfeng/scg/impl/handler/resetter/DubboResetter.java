...
public class DubboResetter extends AbstractResetter {
    ...
    @Value("${com.dwarfeng.scg.dubbo.provider.group}")
    ...
    public interface DubboResetService extends Service {
        ...
        boolean resetGenerate() throws ServiceException;
    }
    ...
    public class DubboResetServiceImpl implements DubboResetService {
        ...
        @Override
        public boolean resetGenerate() throws ServiceException {
            try {
                LOGGER.info("接收到生成功能重置消息, 正在重置生成功能...");
