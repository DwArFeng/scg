...
public class CommonVariableMaintainServiceImpl implements CommonVariableMaintainService {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public PagedData<CommonVariable> lookup() throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public PagedData<CommonVariable> lookup(PagingInfo pagingInfo) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<CommonVariable> lookupAsList() throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<CommonVariable> lookupAsList(PagingInfo pagingInfo) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public PagedData<CommonVariable> lookup(String preset, Object[] objs) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public PagedData<CommonVariable> lookup(String preset, Object[] objs, PagingInfo pagingInfo)
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<CommonVariable> lookupAsList(String preset, Object[] objs) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<CommonVariable> lookupAsList(String preset, Object[] objs, PagingInfo pagingInfo)
            throws ServiceException {
