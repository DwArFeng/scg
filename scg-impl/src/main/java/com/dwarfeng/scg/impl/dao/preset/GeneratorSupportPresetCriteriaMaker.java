...
@Component
public class GeneratorSupportPresetCriteriaMaker implements PresetCriteriaMaker {

    @Override
    public void makeCriteria(DetachedCriteria detachedCriteria, String s, Object[] objects) {
        switch (s) {
            case GeneratorSupportMaintainService.ID_LIKE:
                idLike(detachedCriteria, objects);
                break;
            case GeneratorSupportMaintainService.LABEL_LIKE:
