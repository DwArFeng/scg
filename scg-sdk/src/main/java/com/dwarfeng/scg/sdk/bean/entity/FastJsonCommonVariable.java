...
public class FastJsonCommonVariable implements Bean {
    ...
    private static final long serialVersionUID = 1164157860104105441L;

    public static FastJsonCommonVariable of(CommonVariable commonVariable) {
        if (Objects.isNull(commonVariable)) {
            return null;
        } else {
            return new FastJsonCommonVariable(
